...
export const UnitEconomics: React.FC = () => {
  const [wasteWeightKg, setWasteWeightKg] = useState<number>(100);
  const [informalRate, setInformalRate] = useState<number>(100);
  const [platformRate, setPlatformRate] = useState<number>(120);
  const [recyclerFeePercent] = useState<number>(3.5);
