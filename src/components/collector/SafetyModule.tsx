...
import { SAFETY_GUIDELINES } from '../../services/mockData';
...
export const SafetyModule: React.FC<SafetyModuleProps> = ({ language, onBack }) => {
  const handleSpeakSafety = (guideline: typeof SAFETY_GUIDELINES[0]) => {
