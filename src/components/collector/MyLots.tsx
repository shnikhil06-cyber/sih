...
interface MyLotsProps {
  language: Language;
  onBack: () => void;
}

export const MyLots: React.FC<MyLotsProps> = ({ onBack }) => {
  const [lots] = useState<Lot[]>(() => LocalDatabase.getLots());
  const [selectedLotForReceipt, setSelectedLotForReceipt] = useState<Lot | null>(null);
