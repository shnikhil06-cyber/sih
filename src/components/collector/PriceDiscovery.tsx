...
import type { Language, MaterialCategory } from '../../types';
import { INITIAL_PRICE_DATASET, INITIAL_MATERIALS } from '../../services/mockData';
...
export const PriceDiscovery: React.FC<PriceDiscoveryProps> = ({ language, onBack }) => {
